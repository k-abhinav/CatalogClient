...
(function () {
    ...
    V.prototype.update = function (a, b) {
        if (null != a) {
            ...
            for (var c = b - this.c, d = 0, e = this.B, f = this.j; d < b;) {
                if (0 == f)for (; d <= c;)Ab(this, a, d), d += this.c;
    ...
    var Wc = "https:" === window.location.protocol, Xc = Wc || "http:" === window.location.protocol ? Rc : Uc, Yc = function (a) {
        ...
        return {g: "S" == a.charAt(0), domain: d, i: c}
    }, Zc = function () {
        var a, b = null;
    ...
    var $c = function (a) {
        ...
        d = "E" === c && e.g;
        return !d && ("U" !== c || e.g) || d && !Wc ? b : {N: !0, g: d, ca: a.substr(1), domain: e.domain, i: e.i}
    }, ad = function (a) {
        if (!a)return [];
        a = a.split("=");
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.sB8E5NJ_eLs.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCOVjod4lvOV6JQ1QFKyK9l1Dzn_Dg",
